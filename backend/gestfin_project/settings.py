...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-gestfin-change-in-production-2026')
...
#         'NAME': config('DB_NAME', default='gestfin_db'),
...
AUTH_USER_MODEL = 'gestfin_app.Utilisateur'
